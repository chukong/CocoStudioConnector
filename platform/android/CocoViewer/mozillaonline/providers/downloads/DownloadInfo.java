...
import cn.com.ccspreviewer.PreRender;
...
public class DownloadInfo {
    ...
    public void sendIntentIfRequested() throws IOException {
        if (mPackage == null) {
            return;
        }
        ...
        String pathZip = sdcardPath + "package.zip";
        
        UnZipFolder(pathZip, sdcardPath + "Resources");
        
        Intent broastIntent = new Intent();
        broastIntent.setAction("com.unzip.completed");
        
        mContext.sendBroadcast(broastIntent);
        Log.d("pet", "send broastIntent action : " + broastIntent.getAction());
...
//			public void run() {
//				Intent i = new Intent();
//				i.setClass(mContext, PreRender.class);
...
//		});
    ...
    private void UnZipFolder(String zipFileString, String outPathString)throws IOException 
	 {   
